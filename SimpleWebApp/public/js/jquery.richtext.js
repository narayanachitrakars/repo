    ...
    $.fn.richText = function( options ) {
        ...
        $(document).on("click", "#richText-Video button.btn", function(event) {
            ...
            if($form.attr("data-editor") === editorID) {
                ...
                if(!url) {
                    // no url set
                    $form.prepend($('<div />', {style: 'color:red;display:block;', class: 'form-item is-error', text: settings.translations.pleaseEnterURL}));
                    ...
                    if(!html) {
                        $form.prepend($('<div />', {style: 'color:red;display:block;', class: 'form-item is-error', text: settings.translations.videoURLnotSupported}));
                        $form.children('.form-item.is-error').slideDown();
                        setTimeout(function() {
                            $form.children('.form-item.is-error').slideUp(function () {
                                $(this).remove();
        ...
        $(document).on("click", "#richText-Image button.btn", function(event) {
            ...
            if($form.attr("data-editor") === editorID) {
                ...
                if(!url) {
                    // no url set
                    $form.prepend($('<div />', {style: 'color:red;display:block;', class: 'form-item is-error', text: settings.translations.pleaseSelectImage}));
                    $form.children('.form-item.is-error').slideDown();
                    setTimeout(function() {
                        $form.children('.form-item.is-error').slideUp(function () {
                            $(this).remove();
        ...
        $(document).on("click", "#richText-File button.btn", function(event) {
            ...
            if($form.attr("data-editor") === editorID) {
                ...
                if(!url) {
                    // no url set
                    $form.prepend($('<div />', {style: 'color:red;display:block;', class: 'form-item is-error', text: settings.translations.pleaseSelectFile}));
                    $form.children('.form-item.is-error').slideDown();
                    setTimeout(function() {
                        $form.children('.form-item.is-error').slideUp(function () {
                            $(this).remove();
